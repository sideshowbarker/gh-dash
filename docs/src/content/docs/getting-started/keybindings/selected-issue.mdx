...
Press <kbd>Tab</kbd> when the preview pane is open to enter comment navigation mode. This mode
allows you to navigate between individual comments on the issue and quote reply to them.
